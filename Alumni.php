...
<div class="about container">
		...
		<div class="alert mycol ">
		  <h4 class="text-center">Alumni</h4>
		  <div class="pages_para">
		  	<p>The Department of Computer Science and Engineering has been a symbol of progress from the earliest stages of its conception. Only the brightest of individuals from all over the country congregated under a single notion – to achieve greatness and revolutionize the field of Computer Science and Engineering with their ingenuity and talent. The tradition has been passed down to later generations who also followed in the footsteps of their predecessors to achieve excellence through their effort and performance.
			...
			Click here to visit the group for Computer Science and Engineering, Dhaka University Alumni Association.</p>
		  </div>
		</div>
		...
		<div class="alert mycol ">
		  ...
		  <div class="pages_para">
		  	...
		  	<div class="row">
		  		<div class="col-lg-6">
		  			<img src="image/s1.jpg" alt="..." class="img-thumbnail img-fluid">
